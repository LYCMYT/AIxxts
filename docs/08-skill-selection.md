...
5. `VoltAgent/awesome-design-md`
   - 作为视觉参考库。
   - 本次选择 `design-md/apple/DESIGN.md` 作为参考，但只抽取适合内部工作台的规则：白色表面、浅灰画布、单一动作蓝、系统字体、细边界、弱阴影和低装饰。
...
- 密度：中高密度。
- 动效：低动效，仅状态和交互反馈。
- 视觉：浅色 Apple-inspired 工作台，`#f5f5f7` 画布、白色面板、近黑文字、单一动作蓝，卡片半径控制在 14px 到 18px。
